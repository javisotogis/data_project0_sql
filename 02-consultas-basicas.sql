...
SELECT "CustomerId" AS "ID", "FirstName",
"LastName",
"Company",
"Address",
"City",
...
select * from public."Track" where "Milliseconds" > 300000 order by "Milliseconds";
...
select concat("FirstName", ' ' , "LastName") as "Name", "Email" as "Email_address" from public."Customer" where "Country" = 'Brazil';
...
select * from public."Playlist" where "Name" ilike '%music%';
...
select "FirstName"as "First_Name",  "LastName"as "Last_Name" from public."Employee" where "Title" = 'Sales Support Agent';

-- Ejercicio 7: Seleccionar los nombres de los géneros (`Name`) y renombrar la columna a `Genre_Name`.
select "Name" as "Genre_Name" FROM public."Genre";
...
select "FirstName" as "First_Name", "LastName"as "Last_Name" from public."Employee"  where "EmployeeId" = 1;
...
select "Name" as "Track_name", ("Milliseconds"*0.000017) as "Duration_minutes" from public."Track" where ("Milliseconds"*0.000017) > 5;
...
select "Name" as "Track_name", ("Milliseconds"*0.000017) as "Duration_minutes", "UnitPrice" from public."Track" where "UnitPrice" > 1;
...
select "FirstName"as "First_Name",  "LastName"as "Last_Name" from public."Employee" where "City" = 'Seattle' and "State" = 'WA'; --0
...
select "FirstName"as "First_Name",  "LastName"as "Last_Name", "SupportRepId" from public."Customer" where "Country" = 'USA' and "SupportRepId" >= 5;
...
select "InvoiceId", "Total" from public."Invoice" where "Total" > 10 and "CustomerId" < 50;
...
select * from public."Track" where "Milliseconds" > 250000 and "MediaTypeId" between 1 and 2;
